...
1. 处理 Git 状态检查、执行分支创建或切换
2. 选择下一个可执行 task
3. 准备任务上下文包
4. 调度 `developer`
5. 调度 `reviewer`
6. 根据审查结果决定通过、返工或阻塞
7. 做最终验证并更新当前 task 文件与 `progress.md`
8. 在交付阶段负责切回 `base_branch`、合并并删除 `execute_branch`
...
- 分支创建、切换、merge、删除统一由主代理负责，避免子代理各自改动 Git 状态
